...
# Train 340M Preconditioned KDA on SlimPajama 15B tokens
# Usage: bash scripts/train_precond_kda_340M.sh [--output DIR] [--wandb-project NAME] [--ngpu N]
...
# Defaults
OUTPUT="${REPO_ROOT}/exp/precond_kda_340M"
WANDB_PROJECT_NAME=""
NGPU_ARG=8
...
bash train.sh \
  ...
  --model.config "${REPO_ROOT}/configs/precond_kda_340M.json" \
