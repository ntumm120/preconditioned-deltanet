...
# Train 1B KDA on SlimPajama 50B tokens
# Usage: bash scripts/train_kda_1B.sh [--output DIR] [--wandb-project NAME] [--ngpu N]
...
bash train.sh \
  ...
  --model.config "${REPO_ROOT}/configs/kda_1B.json" \
