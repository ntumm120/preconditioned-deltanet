...
# Train 340M Gated DeltaNet on SlimPajama 15B tokens
# Usage: bash scripts/train_gated_deltanet_340M.sh [--output DIR] [--wandb-project NAME] [--ngpu N]
...
# Defaults
OUTPUT="${REPO_ROOT}/exp/gated_deltanet_340M"
WANDB_PROJECT_NAME=""
NGPU_ARG=8
...
bash train.sh \
  ...
  --model.config "${REPO_ROOT}/configs/gated_deltanet_340M.json" \
