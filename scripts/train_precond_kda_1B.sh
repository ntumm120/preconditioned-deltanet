...
# Train 1B Preconditioned KDA on SlimPajama 50B tokens
# Usage: bash scripts/train_precond_kda_1B.sh [--output DIR] [--wandb-project NAME] [--ngpu N]
...
# Defaults
OUTPUT="${REPO_ROOT}/exp/precond_kda_1B"
WANDB_PROJECT_NAME=""
NGPU_ARG=8
...
bash train.sh \
  ...
  --model.config "${REPO_ROOT}/configs/precond_kda_1B.json" \
