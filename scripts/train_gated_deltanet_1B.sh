...
# Train 1B Gated DeltaNet on SlimPajama 50B tokens
# Usage: bash scripts/train_gated_deltanet_1B.sh [--output DIR] [--wandb-project NAME] [--ngpu N]
...
# Defaults
OUTPUT="${REPO_ROOT}/exp/gated_deltanet_1B"
WANDB_PROJECT_NAME=""
NGPU_ARG=8
...
bash train.sh \
  ...
  --model.config "${REPO_ROOT}/configs/gated_deltanet_1B.json" \
