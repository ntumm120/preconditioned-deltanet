...
# Train 340M KDA on SlimPajama 15B tokens
# Usage: bash scripts/train_kda_340M.sh [--output DIR] [--wandb-project NAME] [--ngpu N]
...
bash train.sh \
  ...
  --model.config "${REPO_ROOT}/configs/kda_340M.json" \
