...
def _atk_backward_chunk_out(
    ...
    for i_k in range(tl.cdiv(D, BK)):
        ...
        if IS_VARLEN:
            ...
            gkp_ptr = g_kp + b * gkp_stride_b + h * gkp_stride_h + (gkp_stride_t * T_range)[:, None] + (gkp_stride_d) * D_range[None, :]
        ...
        if IS_VARLEN:
            ...
            gk_ptr = gk_out + b * gk_stride_b + T_range[:, None] * gk_stride_t + h * gk_stride_h + D_range[None, :] * gk_stride_d
